...
onready var body_position := $BodyPosition
...
func spawn(dice_core: DiceCoreResource, lower_limit: int, upper_limit: int) -> void:
...
func dead() -> void:
	...
	drop_dice.global_position = body_position.global_position - Vector2(40, 0)
	...
	drop_limiter.global_position = body_position.global_position + Vector2(40, 0)
